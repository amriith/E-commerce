...
export const Signup = () => {
    return (
<div>
<div className="flex justify-center grid place-items-center bg-gray-200 object-scale-down flex-col shadow-lg rounded-lg   md:w-[280px] h-[370px] mx-auto">
<div className="w-full rounded-md text-center bg-gray-200 justify-center items-center p-1 h-max">
 
    <p className="mb-2 text-xs">Sign up with</p> 
...
<p className="mb-2 text-xs">Or sign up with credentials</p>
